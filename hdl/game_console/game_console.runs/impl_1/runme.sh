...
HD_PWD='C:/Users/dyrge/Documents/EEL4744/game_console/hdl/game_console/game_console.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log console.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source console.tcl -notrace
