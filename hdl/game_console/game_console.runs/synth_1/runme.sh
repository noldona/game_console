...
HD_PWD='C:/Users/dyrge/Documents/EEL4744/game_console/hdl/game_console/game_console.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log console.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source console.tcl
